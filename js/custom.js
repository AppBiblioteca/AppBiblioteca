...
jQuery(document).ready(function($){
	...
	if($('.Gestion LibrosList').width()) {
		
		if(jQuery.browser.version.substring(0, 2) == "8.") {

			$('ul.Gestion LibrosList li:nth-child(2n+1)').addClass('odd');
...
function messageLike(){
	...
	if($('.Gestion LibrosList')) {
		
		$('.Gestion LibrosList').on('click', '.star', function(){
		...
		$('.Gestion LibrosList').on('click', '.dislikes', function(){
